...
public class Writer {
	...
	// private final String[] titles = { "Dia", "Nome", "Entrada",
	// "Saída_almoço", "Retorno_Almoço", "Saída", "Horas Trabalhadas" };

	private File fileOut;

	public Writer(String fileOut) {
		if (fileOut == null || fileOut.isEmpty())
			throw new NullPointerException("Arquivo de saída não pode ser nulo ou vazio");
